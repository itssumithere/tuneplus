          ...
          <section className="daily-trend content">
            <div className="top-store dash-detail dash-detail-two">
              <div className="track-heading d-flex flex-wrap align-items-center justify-content-between">
                <div class="track-heading d-flex flex-wrap align-items-center justify-content-between"></div>
                <h2>Track Earning</h2>
                ...
                {trackList.length > 0 ? (
                  ...
                  <div className="dash-detail mt-4">
                            ...
                            <tr className="odd">
                              ...
                              <td>
                                ...
                                {item.Excel != "" && (
                                  <a
                                    onClick={() => {
                                      downloadFile(item.Excel, item.name);
                                    }}
                                  >
                  ...
                  <>
                    <img
                      className="img-fluid"
                      title="Dashboard"
                      src={require("../../assets/images/nodatafound.png")}
                    />
                  </>
                )}
              </div>
